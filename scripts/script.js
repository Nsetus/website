const userID = "680776226478096522"; // Change this to your Discord user ID
...
async function fetchDiscordStatus() {
	try {
		const [lanyardResponse, lookupResponse] = await Promise.all([
			fetch(`https://api.lanyard.rest/v1/users/639668795597651978`).then((response) =>
				response.json()
			),
			fetch(`https://discordlookup.mesalytic.moe/v1/user/639668795597651978`).then(
